...
public class controlCategorias extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println(request.getParameter("codigoCategoria"));
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        LinkedList<Productos> arrProdCat = pd.productoPorIDCategoria(codigoCategoria);
        StringBuilder sb = new StringBuilder("");
        for (Productos pr : arrProdCat) {
            sb.append(pr.getId_producto()+"-"+pr.getNombre()+":");
        }
