 ...
 * @author Dr4g0n
 */
public class controlOcuparMesas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int idMesa = Integer.parseInt(request.getParameter("txtIdMesaLibre"));
        ...
        boolean tomarMesaGarzon = PedidosDAO.insertarRegistroPedidoGarzon(ped);
