        ...
        }else
        {
            ...
            if(existeCli == true)
            {
                 ...
                 }else
                 {
                    ...
                    // parse 
                    String cutFecha[] = fechaReserva.split("/");
                    String dia = cutFecha[0];
                    String mes = cutFecha[1];
                    String year = cutFecha[2];
                    
                    String fechaReservaStr = year+"-"+mes+"-"+dia;
                    
                   // String reservacion  = fechaReserva.concat(" ".concat(horaReserva)) ;
                    SimpleDateFormat fd = new SimpleDateFormat("yyyy-MM-dd HH:mm");
                    String sReservacion  = fechaReservaStr+" "+horaReserva;
                    Date fechaHoraRes = fd.parse(sReservacion);
