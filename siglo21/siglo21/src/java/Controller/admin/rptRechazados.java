 ...
 * @author Dr4g0n
 */
public class rptRechazados extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        File directorioRechazados = new File(System.getProperty("user.home")+"/desktop/Reporte SigloXXI/Reportes Clientes Rechazados");
        ...
        LinkedList<Clientes> arrRechazos = new LinkedList<>();
        arrRechazos = ClientesDAO.listaRechazosCli();
       ...
       Paragraph fecha = new Paragraph("Fecha: "+fechaHoy+"\n", fuente);
        ...
        String file = System.getProperty("user.home")+"/desktop/Reporte SigloXXI/Reportes Clientes Rechazados/Reporte_Rechazados_"+numero+".pdf";
        ...
        int contador = 0;
        for (int i = 0; i < arrRechazos.size(); i++) {
            contador = contador + 1;
            String rutCli   = arrRechazos.get(i).getRut_cliente();
            String nombres  = arrRechazos.get(i).getNombres();
            String Apellidos= arrRechazos.get(i).getApellidos();
            ...
            tabla.addCell(new Paragraph(nomApe.toUpperCase(),FontFactory.getFont("arial",9,Font.BOLD,BaseColor.BLACK)));
        }
        ...
        request.setAttribute("pdfRechazosGenerado", "true");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(rptRechazados.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
